...
public:
	...
	static void log_prologue(void);
	static void log_chapter_2(void);
	static void log_chapter_3(void);
	static void log_chapter_4(void);
	...
	static void log_infinite_mode_start(void);
