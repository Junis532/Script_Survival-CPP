...
public:
	...
	void UI_control_game_mode(UI_state_t* ui_main_state, game_mode_state_t* ui_mode_state, game_mode_state_t* game_mode, int key, bool is_infinite_unlocked);
